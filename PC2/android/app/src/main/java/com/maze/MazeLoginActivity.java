                ...
                if (response.isSuccessful()) {
                    ...
                    try {
                        ...
                        if (success) {
                            ...
                            String idUtilizador = jsonResponse.optString("IDUtilizador", "");
                            String tipo         = jsonResponse.optString("Tipo", "");
                            runOnUiThread(() -> {
                                Toast.makeText(MazeLoginActivity.this,
                                        "Login bem-sucedido! Tipo: " + tipo, Toast.LENGTH_SHORT).show();
